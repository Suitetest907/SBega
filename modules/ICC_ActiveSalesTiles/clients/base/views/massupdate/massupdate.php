...
* by Insignio CRM are Copyright (C) 2019 Insignio CRM GmbH. All Rights Reserved.*/
 ...
 $module_name = 'ICC_ActiveSalesTiles'; $viewdefs[$module_name]['base']['view']['massupdate'] = [ 'buttons' => [ [ 'type' => 'button', 'value' => 'cancel', 'css_class' => 'btn-link btn-invisible cancel_button', 'label' => 'LBL_CANCEL_BUTTON_LABEL', 'primary' => false, ], [ 'name' => 'update_button', 'type' => 'button', 'label' => 'LBL_UPDATE', 'acl_action' => 'massupdate', 'css_class' => 'btn-primary', 'primary' => true, ], ], 'panels' => [ [ 'fields' => [ ] ] ] ]; 