...
* by Insignio CRM are Copyright (C) 2019 Insignio CRM GmbH. All Rights Reserved.*/
 ...
 $module_name = 'ICC_ActiveSalesTiles'; $viewdefs[$module_name]['base']['view']['selection-list'] = [ 'panels' => [ [ 'label' => 'LBL_PANEL_1', 'fields' => [ [ 'name' => 'name', 'label' => 'LBL_LIST_NAME', 'enabled' => true, 'default' => true, 'link' => true, 'type' => 'name', ], [ 'name' => 'doc_type', 'label' => 'LBL_LIST_DOC_TYPE', 'enabled' => true, 'default' => true, ], [ 'name' => 'active_date', 'label' => 'LBL_LIST_ACTIVE_DATE', 'enabled' => true, 'default' => false, ], ], ], ], ]; 