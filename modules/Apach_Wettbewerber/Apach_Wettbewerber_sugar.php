 ...
 * PLACE ANY CUSTOMIZATIONS IN Apach_Wettbewerber
 */

require_once 'include/SugarObjects/templates/company/Company.php';

class Apach_Wettbewerber_sugar extends Company {
    public $new_schema = true;
    public $module_dir = 'Apach_Wettbewerber';
    public $object_name = 'Apach_Wettbewerber';
    public $table_name = 'apach_wettbewerber';
    ...
    public $twitter;
    public $googleplus;
    public $apach_wettbewerber_type;
    public $industry;
