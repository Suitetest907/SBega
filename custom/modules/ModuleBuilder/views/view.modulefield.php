...
class CustomViewModulefield extends SugarView
{
    /**
     * @var FieldViewer
     */
        ...
        )
    {
		...
		*/
        ...
        if(empty($_REQUEST['view_package']) || $_REQUEST['view_package'] == 'studio') {
            ...
            } elseif (isset($vardef['custom_module']) || (isset($vardef['icc_is_studio_plus']) && $vardef['icc_is_studio_plus'])) {
            ...
            if($isNew && $vardef['type'] === 'varchar' && $vardef['len'] === 255) {
                $vardef['len'] = 50;
            }
