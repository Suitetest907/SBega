...
<table style="width:100%;" class="relform">
	...
	<tr><td colspan=2>
		<table class="edit view">
			...
			{/if}
				<tr>
					<td align="right" scope="row"><label for="inputLinkFieldNameLeft">Link Field Name</label></td>
					<td><input type="text" name="inputLinkFieldNameLeft" id="inputLinkFieldNameLeft" value="{$rel.icc_lhs_link_name}" {if $rel.readonly} readonly {/if}></td>
					<td></td>
					<td align="right" scope="row"><label for="inputLinkFieldNameRight">Link Field Name</label></td>
					<td><input type="text" name="inputLinkFieldNameRight" id="inputLinkFieldNameRight" value="{$rel.icc_rhs_link_name}" {if $rel.readonly} readonly {/if}></td>
				</tr>
			{/if}
		</table>
	</td></tr>
	<tr >
		<td>
			...
			<input type="text" value="{$rel.relationship_name}" name="relationship_name" {if $rel.readonly} readonly {/if}/>
		</td>
	</tr>
</table>
</form>
