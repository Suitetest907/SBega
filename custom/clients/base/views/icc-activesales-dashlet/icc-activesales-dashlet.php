...
$viewdefs['base']['view']['icc-activesales-dashlet'] = [ 'dashlets' => [ [ 'label' => 'LBL_ACTIVESALES_DASHLET', 'description' => 'LBL_ACTIVESALES_DASHLET_DESCRIPTION', 'config' => [], 'preview' => [], 'filter' => [ 'module' => ['Home'], 'view' => 'record' ], ], ], ]; 